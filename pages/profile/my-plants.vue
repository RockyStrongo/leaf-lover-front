<template>
  ...
  <div class="flex flex-wrap flex-row justify-around py-3">
      <template v-if="plants !== null && !isLoading">
        <div v-for="plantInfo in plants" :key="plantInfo.id">
          <PlantCard :plant="plantInfo.plant" :userActions="[]" :userPlants="plantInfo.plant.UserPlant ?? undefined"/>
        </div>
      </template>
...
import { getApiBase } from '../../composables/getApiBase'
